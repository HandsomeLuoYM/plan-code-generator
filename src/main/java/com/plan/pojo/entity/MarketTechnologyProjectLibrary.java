...
@ApiModel(value="MarketTechnologyProjectLibrary对象", description="附表1-10.3 中低压配电网营销技改规划项目库")
public class MarketTechnologyProjectLibrary implements Serializable {
    ...
    @ApiModelProperty(value = "项目一级分类")
    @TableField("XMYJFL")
    private String xmyjfl;

    @ApiModelProperty(value = "项目二级分类")
    @TableField("XMEJFL")
    private String xmejfl;

    @ApiModelProperty(value = "项目性质")
    @TableField("XMXZ")
    private String xmxz;

    @ApiModelProperty(value = "是否纯采购类")
    @TableField("SFCCGL")
    private String sfccgl;
    ...
    @ApiModelProperty(value = "项目建设必要性分类")
    @TableField("SFJSBYXFL")
    private String sfjsbyxfl;
